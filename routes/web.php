...
Route::get('advert/destroy/{id}', 'AdvertController@destroy')->name('advert.destroy'); //buvo methos delete
Route::post('advert/destroyMany/{id}', 'AdvertController@destroyMany')->name('advert.destroyMany');
Route::post('advert/deletePermanent', 'AdvertController@deletePermanent')->name('advert.deletePermanent');
Route::get('advert/create', 'AdvertController@create')->name('advert.create');
Route::post('advert/createad/{id}', 'AdvertController@createAd')->name('advert.createAd');
Route::get('advert/editAd/{id}', 'AdvertController@editAd')->name('advert.editAd');
...
Route::post('attributes', 'AttributesController@setAttribute')->name('attributes.setAttribute');
